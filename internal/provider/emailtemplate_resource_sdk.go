...
func (r *EmailTemplateResourceModel) ToSharedEmailTemplateEntity() *shared.EmailTemplateEntity {
	...
	subject := new(string)
	if !r.Subject.IsUnknown() && !r.Subject.IsNull() {
		*subject = r.Subject.ValueString()
	} else {
		subject = nil
	}
	...
	out := shared.EmailTemplateEntity{
		CreatedAt:      createdAt,
		ID:             id,
		Manifest:       manifest,
		Org:            org,
