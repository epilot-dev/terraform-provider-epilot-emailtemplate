...
1. Execute `go build` to construct a binary called `terraform-provider-epilot-emailtemplate`
...
provider_installation {
  ...
  dev_overrides {
      "registry.terraform.io/epilot-dev/epilot-emailtemplate" = "<PATH>"
  }
...
* [epilot-emailtemplate_email_template](docs/resources/email_template.md)
### Data Sources

* [epilot-emailtemplate_email_template](docs/data-sources/email_template.md)
